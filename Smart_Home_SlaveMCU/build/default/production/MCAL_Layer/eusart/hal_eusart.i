...
# 12 "MCAL_Layer/eusart/../GPIO/hal_gpio.h"
# 1 "MCAL_Layer/eusart/../GPIO/hal_gpio_cfg.h" 1
# 12 "MCAL_Layer/eusart/../GPIO/hal_gpio.h" 2


# 1 "MCAL_Layer/eusart/../GPIO/../std_types.h" 1
# 13 "MCAL_Layer/eusart/../GPIO/../std_types.h"
# 1 "MCAL_Layer/eusart/../GPIO/../compiler.h" 1
# 12 "MCAL_Layer/eusart/../GPIO/../compiler.h"
...
# 12 "MCAL_Layer/eusart/../GPIO/../compiler.h" 2
# 13 "MCAL_Layer/eusart/../GPIO/../std_types.h" 2

# 1 "MCAL_Layer/eusart/../GPIO/../std_libraries.h" 1
# 12 "MCAL_Layer/eusart/../GPIO/../std_libraries.h"
...
# 12 "MCAL_Layer/eusart/../GPIO/../std_libraries.h" 2
...
# 14 "MCAL_Layer/eusart/../GPIO/../std_libraries.h" 2
# 14 "MCAL_Layer/eusart/../GPIO/../std_types.h" 2
# 23 "MCAL_Layer/eusart/../GPIO/../std_types.h"
...
# 14 "MCAL_Layer/eusart/../GPIO/hal_gpio.h" 2

# 1 "MCAL_Layer/eusart/../GPIO/../device_config.h" 1
# 15 "MCAL_Layer/eusart/../GPIO/hal_gpio.h" 2
...
# 11 "MCAL_Layer/eusart/../interrupt/internal_interrupt.h"
# 1 "MCAL_Layer/eusart/../interrupt/mcal_interrupt.h" 1
# 12 "MCAL_Layer/eusart/../interrupt/mcal_interrupt.h"
# 1 "MCAL_Layer/eusart/../interrupt/mcal_interrupt_cfg.h" 1
# 12 "MCAL_Layer/eusart/../interrupt/mcal_interrupt.h" 2
# 51 "MCAL_Layer/eusart/../interrupt/mcal_interrupt.h"
typedef enum {
    INTERRUPT_LOW_PRIORITY,
    INTERRUPT_HIGH_PRIORITY
} priority_level_t;
# 11 "MCAL_Layer/eusart/../interrupt/internal_interrupt.h" 2
# 13 "MCAL_Layer/eusart/hal_eusart.h" 2
# 66 "MCAL_Layer/eusart/hal_eusart.h"
typedef enum {
...
static void (*EUSART_FramingError_Handler)(void) = ((void*)0);
static void (*EUSART_OverrunError_Handler)(void) = ((void*)0);
...
# 58 "MCAL_Layer/eusart/hal_eusart.c"
STD_ReturnType EUSART_ASYNC_DEINIT(const usart_t *usart) {
    STD_ReturnType ret = (STD_ReturnType)0x01;
    if (((void*)0) == usart) {
        ret = (STD_ReturnType)0x00;
...
# 79 "MCAL_Layer/eusart/hal_eusart.c"
STD_ReturnType EUSART_ASYNC_READ_BYTE_BLOCKING(const usart_t *usart, uint8 *data) {
    STD_ReturnType ret = (STD_ReturnType)0x01;
    if (((void*)0) == usart) {
        ret = (STD_ReturnType)0x00;
...
# 102 "MCAL_Layer/eusart/hal_eusart.c"
STD_ReturnType EUSART_ASYNC_READ_BYTE_NON_BLOCKING(const usart_t *usart, uint8 *data) {
    STD_ReturnType ret = (STD_ReturnType)0x01;
    if (((void*)0) == usart) {
        ret = (STD_ReturnType)0x00;
...
# 128 "MCAL_Layer/eusart/hal_eusart.c"
STD_ReturnType EUSART_ASYNC_WRITE_BYTE_BLOCKING(const usart_t *usart, uint8 data) {
    STD_ReturnType ret = (STD_ReturnType)0x01;
    if (((void*)0) == usart) {
        ret = (STD_ReturnType)0x00;
...
# 157 "MCAL_Layer/eusart/hal_eusart.c"
STD_ReturnType EUSART_ASYNC_WRITE_STRING_BLOCKING(const usart_t *usart,const uint8 *data, uint16 str_len) {
    STD_ReturnType ret = (STD_ReturnType)0x01;
    uint8 str_ctr = 0;
    if (((void*)0) == usart) {
...
# 181 "MCAL_Layer/eusart/hal_eusart.c"
STD_ReturnType EUSART_ASYNC_WRITE_BYTE_NON_BLOCKING(const usart_t *usart, uint8 data) {
    STD_ReturnType ret = (STD_ReturnType)0x01;
    if (((void*)0) == usart) {
        ret = (STD_ReturnType)0x00;
...
# 209 "MCAL_Layer/eusart/hal_eusart.c"
STD_ReturnType EUSART_ASYNC_WRITE_STRING_NON_BLOCKING(const usart_t *usart, uint8 *data, uint16 str_len) {
    STD_ReturnType ret = (STD_ReturnType)0x01;
    uint8 str_ctr = 0;
    if (((void*)0) == usart) {
...
# 241 "MCAL_Layer/eusart/hal_eusart.c"
static STD_ReturnType EUSART_Baud_Rate_Calculation(const usart_t *usart) {
    STD_ReturnType ret = (STD_ReturnType)0x01;
    ...
    if (((void*)0) == usart) {
        ...
        switch (usart->baudrate_gen) {
            case EUSART_8BIT_ASYNCHRONOUS_LOW_SPEED:
                ...
                TXSTAbits.BRGH = 0;
                BAUDCONbits.BRG16 = 0;
                baudrate_temp = ((16000000UL / (float) usart->baudrate_value) / 64) - 1;
                ret = (STD_ReturnType)0x01;
                break;
            case EUSART_8BIT_ASYNCHRONOUS_HIGH_SPEED:
                ...
                TXSTAbits.BRGH = 1;
                BAUDCONbits.BRG16 = 0;
                baudrate_temp = ((16000000UL / (float) usart->baudrate_value) / 16) - 1;
                ret = (STD_ReturnType)0x01;
                break;
            ...
            case EUSART_16BIT_ASYNCHRONOUS_HIGH_SPEED:
                ...
                TXSTAbits.BRGH = 1;
                BAUDCONbits.BRG16 = 1;
                baudrate_temp = ((16000000UL / (float) usart->baudrate_value) / 4) - 1;
                ret = (STD_ReturnType)0x01;
                break;
...
# 311 "MCAL_Layer/eusart/hal_eusart.c"
static STD_ReturnType EUSART_ASYNC_TX_INIT(const usart_t *usart) {
    STD_ReturnType ret = (STD_ReturnType)0x01;
    if (((void*)0) == usart) {
        ret = (STD_ReturnType)0x00;
    } else {
        if (usart->usart_tx_cfg.usart_tx_enable == 1) {
            TXSTAbits.TXEN = 1;

            if (usart->usart_tx_cfg.usart_tx_interupt_enable == 1) {
...
# 333 "MCAL_Layer/eusart/hal_eusart.c"
        ...
        } else if (usart->usart_tx_cfg.usart_tx_interupt_enable == 0) {
            (PIE1bits.TXIE= 0);
        } else {
        }

        if (usart->usart_tx_cfg.usart_tx_9bit_enable == 1) {
            TXSTAbits.TX9D = 1;
        } else if (usart->usart_tx_cfg.usart_tx_9bit_enable == 0) {
            TXSTAbits.TX9D = 0;
        } else {
        }
        ret = (STD_ReturnType)0x01;
...
# 372 "MCAL_Layer/eusart/hal_eusart.c"
static STD_ReturnType EUSART_ASYNC_RX_INIT(const usart_t *usart) {
    STD_ReturnType ret = (STD_ReturnType)0x01;
    if (((void*)0) == usart) {
        ret = (STD_ReturnType)0x00;
    } else {
        if (usart->usart_rx_cfg.usart_rx_enable == 1) {
            RCSTAbits.CREN = 1;

            if (usart->usart_rx_cfg.usart_rx_interupt_enable == 1) {

                (PIE1bits.RCIE = 1);
# 394 "MCAL_Layer/eusart/hal_eusart.c"
                (INTCONbits.GIE = 1);
                (INTCONbits.PEIE = 1);
        ...
        } else if (usart->usart_rx_cfg.usart_rx_interupt_enable == 0) {
            (PIE1bits.RCIE= 0);
        } else {
        }

        if (usart->usart_rx_cfg.usart_rx_9bit_enable == 1) {
            RCSTAbits.RC9 = 1;
        } else if (usart->usart_rx_cfg.usart_rx_9bit_enable == 0) {
            RCSTAbits.RC9 = 0;
        } else {
        }
        ret = (STD_ReturnType)0x01;
