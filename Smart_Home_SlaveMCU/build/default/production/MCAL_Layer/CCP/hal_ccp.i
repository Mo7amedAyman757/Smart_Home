...
# 13 "MCAL_Layer/CCP/../GPIO/../std_types.h"
# 1 "MCAL_Layer/CCP/../GPIO/../compiler.h" 1
# 12 "MCAL_Layer/CCP/../GPIO/../compiler.h"
...
# 12 "MCAL_Layer/CCP/../GPIO/../std_libraries.h" 2
...
# 14 "MCAL_Layer/CCP/../GPIO/../std_types.h" 2
# 23 "MCAL_Layer/CCP/../GPIO/../std_types.h"
...
# 1 "MCAL_Layer/CCP/../interrupt/internal_interrupt.h" 1
# 11 "MCAL_Layer/CCP/../interrupt/internal_interrupt.h"
# 1 "MCAL_Layer/CCP/../interrupt/mcal_interrupt.h" 1
# 12 "MCAL_Layer/CCP/../interrupt/mcal_interrupt.h"
# 1 "MCAL_Layer/CCP/../interrupt/mcal_interrupt_cfg.h" 1
# 12 "MCAL_Layer/CCP/../interrupt/mcal_interrupt.h" 2
# 51 "MCAL_Layer/CCP/../interrupt/mcal_interrupt.h"
typedef enum {
    INTERRUPT_LOW_PRIORITY,
    INTERRUPT_HIGH_PRIORITY
} priority_level_t;
# 11 "MCAL_Layer/CCP/../interrupt/internal_interrupt.h" 2
...
# 141 "MCAL_Layer/CCP/hal_ccp.c"
STD_ReturnType CCP_CaptureDataRead(const ccp_t * ccp, uint16 *capture_value) {
    STD_ReturnType ret = (STD_ReturnType)0x00;
    CCP_REG_T capture_time_val = {.ccpr_low = 0, .ccpr_high = 0};
    if ((((void*)0) == ccp) || (((void*)0) == capture_value)) {
        ret = (STD_ReturnType)0x00;
    } else {
        if (ccp->ccp_inst == CCP1_INST) {
...
# 495 "MCAL_Layer/CCP/hal_ccp.c"
static void CCP_interrupt_config(const ccp_t * ccp) {
    if (ccp->ccp_inst == CCP1_INST) {

        (PIE1bits.CCP1IE = 1);
        (PIR1bits.CCP1IF = 0);
# 511 "MCAL_Layer/CCP/hal_ccp.c"
        (INTCONbits.GIE = 1);
        (INTCONbits.PEIE = 1);
