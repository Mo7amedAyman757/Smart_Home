...
# 13 "MCAL_Layer/I2C/../GPIO/../std_types.h"
# 1 "MCAL_Layer/I2C/../GPIO/../compiler.h" 1
# 12 "MCAL_Layer/I2C/../GPIO/../compiler.h"
...
# 14 "MCAL_Layer/I2C/../GPIO/../std_types.h" 2
# 23 "MCAL_Layer/I2C/../GPIO/../std_types.h"
...
# 11 "MCAL_Layer/I2C/../interrupt/internal_interrupt.h"
# 1 "MCAL_Layer/I2C/../interrupt/mcal_interrupt.h" 1
# 12 "MCAL_Layer/I2C/../interrupt/mcal_interrupt.h"
# 1 "MCAL_Layer/I2C/../interrupt/mcal_interrupt_cfg.h" 1
# 12 "MCAL_Layer/I2C/../interrupt/mcal_interrupt.h" 2
# 51 "MCAL_Layer/I2C/../interrupt/mcal_interrupt.h"
typedef enum {
    INTERRUPT_LOW_PRIORITY,
    INTERRUPT_HIGH_PRIORITY
} priority_level_t;
# 11 "MCAL_Layer/I2C/../interrupt/internal_interrupt.h" 2
# 13 "MCAL_Layer/I2C/hal_i2c.h" 2
# 72 "MCAL_Layer/I2C/hal_i2c.h"
typedef struct {
    uint8 i2c_mode;
...
static void (*I2C_Report_Write_Collision_Interrupt_Handler)(void) = ((void*)0);
static void (*I2C_Default_Interrupt_Handler)(void) = ((void*)0);
static void (*I2C_Report_Recieve_Overflow_Interrupt_Handler)(void) = ((void*)0);


static __attribute__((inline)) void MSSP_I2C_MODE_GPIO_CFG(void);
static __attribute__((inline)) void I2C_Slave_Mode_Config(const mssp_i2c_t *i2c_obj);
static __attribute__((inline)) void I2C_MASTER_MODE_CLOCK_CONFIG(const mssp_i2c_t *i2c_obj);
static __attribute__((inline)) void MSSP_I2C_Interrupt_config(const mssp_i2c_t *i2c_obj);
...
STD_ReturnType MSSP_I2C_Init(const mssp_i2c_t *i2c_obj) {
    ...
    if (i2c_obj == ((void*)0)) {
        ...
        if (i2c_obj->i2c_config.i2c_mode == 1) {
            I2C_MASTER_MODE_CLOCK_CONFIG(i2c_obj);
        } else if (i2c_obj->i2c_config.i2c_mode == 0) {

            if (i2c_obj->i2c_config.i2c_generel_call == 1) {
                (SSPCON2bits.GCEN = 1);
            } else if (i2c_obj->i2c_config.i2c_generel_call == 0) {
                (SSPCON2bits.GCEN = 0);
            } else {
        ...
        if (i2c_obj->i2c_config.i2c_slew_rate == 0) {
            (SSPSTATbits.SMP = 0);
        } else if (i2c_obj->i2c_config.i2c_slew_rate == 1) {
            (SSPSTATbits.SMP = 1);
        } else {

        }

        if (i2c_obj->i2c_config.i2c_smbus == 1) {
            (SSPSTATbits.CKE = 1);
        } else if (i2c_obj->i2c_config.i2c_smbus == 0) {
            (SSPSTATbits.CKE = 0);
        } else {
...
# 263 "MCAL_Layer/I2C/hal_i2c.c"
static __attribute__((inline)) void I2C_MASTER_MODE_CLOCK_CONFIG(const mssp_i2c_t *i2c_obj) {
    SSPCON1bits.SSPM = i2c_obj->i2c_config.i2c_mode_config;
    SSPADD = (uint8) (((16000000UL / 4.0) / i2c_obj->clock) - 1);
