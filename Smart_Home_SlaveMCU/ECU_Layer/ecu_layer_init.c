...
//    .keypad_columns_pins[1].pin = GPIO_PIN6,
...
//    .keypad_columns_pins[2].pin = GPIO_PIN7,
...
chr_lcd_4bit_t lcd_1 = {
    ...
    .lcd_data[0].pin = GPIO_PIN3,
    .lcd_data[0].direction = GPIO_DIRECTION_OUTPUT,
    .lcd_data[0].logic = GPIO_LOW,

    .lcd_data[1].port = PORTD_INDEX,
    .lcd_data[1].pin = GPIO_PIN4,
    .lcd_data[1].direction = GPIO_DIRECTION_OUTPUT,
    .lcd_data[1].logic = GPIO_LOW,

    .lcd_data[2].port = PORTD_INDEX,
    .lcd_data[2].pin = GPIO_PIN5,
    .lcd_data[2].direction = GPIO_DIRECTION_OUTPUT,
    .lcd_data[2].logic = GPIO_LOW,

    .lcd_data[3].port = PORTD_INDEX,
    .lcd_data[3].pin = GPIO_PIN6,
...
void ecu_layer_initialize(void) {
    ...
    relay_initialization(&relay1);
    motor_initialization(&motor1);
    motor_initialization(&motor2);
